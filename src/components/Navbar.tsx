      ...
      <div className="flex w-full max-w-[1300px] flex-col items-center gap-2">
        ...
        >
          <div className="hidden flex-row items-center gap-2 md:flex md:gap-4">
            <Link href="https://maps.app.goo.gl/M3ugZudBQLzDzSiUA" target="_blank" className="flex items-center gap-2 text-xs text-white md:text-sm">
              <MapPin />1 Nab Lane, Blackburn, BB2 1LN
            </Link>
            <p className="flex items-center gap-2 text-xs text-white md:text-sm">
              <Clock />
              Mon-Sat 11:00AM - 23:00PM, Sun 12:00PM - 23:00PM
            </p>
          </div>
          <div className="hidden flex-row items-center gap-2 md:flex md:gap-4">
            <Link
              href="tel:0125 424 1298"
              target="_blank"
            ...
            <Link
              href="mailto:reservations@istanbulrestaurantblackburn.co.uk"
              target="_blank"
              className="flex items-center gap-2 text-xs text-white md:text-sm"
            >
              <Mail />
              reservations@istanbulrestaurantblackburn.co.uk
            </Link>
          </div>
        </div>
